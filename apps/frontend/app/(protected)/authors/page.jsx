...
export default function AuthorsPage() {
  ...
  const fetchAuthors = async () => {
    ...
    setError(null);
    try {
      const res = await api.authors.getAll(page);
  ...
  const isEmpty = !loading && authors.length === 0;
    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {loading && (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">Loading authors...</p>
        </div>
      )}

      {isEmpty && (
        <div className="text-center py-16 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
          <p className="text-gray-600 text-lg mb-2">No authors found</p>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {authors.map((author) => (
                  ...
                  >
                    <td className="px-6 py-4 text-gray-800">{author.name}</td>
